...
def option_a
  puts "Give me a name"
  nam1 = gets.chomp
  puts "Give me an verb ending in ing"
  ac1 = gets.chomp
  puts "Give me a time"
  num1 = gets.chomp
  puts "Give me another name"
  nam2 = gets.chomp
  puts "Give me an adjective ending in ly"
  adjective1 = gets.chomp
  ...
  puts "Give me a food"
  food1 = gets
  puts "#{nam1} was  #{ac1} at #{num1} and #{nam2} suddenly came along and #{adjective1} #{verb1} and then #{nam2} #{verb2} away. After a #{noun1} ran away to #{pla1} I went and got #{food1}"
end
   
def mad_libs
  puts "Hello! Welcome to Mad Libs. When you ready to start type a, b, or c."
  option = gets.chomp
  if option == "a"
    puts option_a
  else
